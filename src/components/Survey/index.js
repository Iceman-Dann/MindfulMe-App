...
const Survey = () => {
    ...
    const handleImageUpload = async (questionId, file) => {
        // TODO: Implement image upload without Firebase
        console.log("Image upload disabled:", questionId, file);
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            // TODO: Implement survey data saving without Firebase
            console.log("Survey submission disabled:", surveyData);
        } catch (error) {

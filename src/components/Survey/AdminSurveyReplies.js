...
const AdminSurveyReplies = () => {
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        ...
        console.log("User data fetching disabled");
        setUserData([]);
      } catch (error) {
  ...
  useEffect(() => {
    const fetchSurveyData = async () => {
      ...
      try {
        // TODO: Implement survey data fetching without Firebase
        console.log("Survey data fetching disabled for user:", selectedUser);
        setSurveyData([]);
      } catch (error) {
